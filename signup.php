	...
	<section id="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="wulogin.php">
...
<input type="radio" value="male" name="gender"><label style="margin-right:20px;"> Male </label>
<input type="radio"value="female" name="gender"><label style="margin-right:20px;">Female </label>
