        ...
        <div class="container">
            ...
            <ul class="choice">
               <li ><a class="btn btn-default " href="home.php" >Add Operator</a></li>
                ...
                <li><a class="btn btn-default" href="offers.php" style="background: #1BBD36;color:#FFFFFF">add offers</a></li>
	...
	<section id="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form"  method="post" action="woffers.php">
