...
<title>Dashboard</title>
        ...
        <div class="container">
            ...
            <ul class="choice">
               <li ><a class="btn btn-default " href="home.php" >Add Operator</a></li>
                ...
                <li ><a class="btn btn-default" href="viewoptr.php" style="background: #1BBD36;color:#FFFFFF" >view operator</a></li>
  ...
  <div style="position:absolute;margin-top:50px;margin-right:60px;">              
  <table border="1" cellpadding="20px"  style="margin-top:20px;margin-bottom:50px;" >
                 
<tr bgcolor="#555555" ;  height="70px" style="color:#FFFFFF;text-align:center" align="center">
