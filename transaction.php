...
<html lang="en">
        ...
        <div class="container">
            ...
            <ul class="choice">
               <li ><a class="btn btn-default " href="uhome.php" >recharge now</a></li>
                ...
                <li><a class="btn btn-default" href="u_plan.php" >view Plans</a></li>
                <li ><a class="btn btn-default" href="transaction.php" style="background: #1BBD36;color:#FFFFFF" >Transaction History</a></li>
 ...
 <div style="position:absolute;margin-top:50px;margin-right:30px;">              
